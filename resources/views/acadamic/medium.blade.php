...
@section('content')
        <html>
                <body>
                        <h1 style="margin-left: -60%;font-size: 30px;"> <b>Manage Medium</b> </h1>

                        <div style="background-color:rgb(242, 241, 240);width:50%;height:85%;">
                                <form id="yes">
                                        <h5 style="margin-left:-54%;"><br><b>Create Medium</b></h5><br>
                        ...
                        <div class="modal fade" id="updatemodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="updateLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                        ...
                                        <h1 class="modal-title fs-5" id="updateLabel">Medium</h1>
                        ...
                        <div style="background-color:rgb(242, 241, 240);width:50%;height:85%;margin-left:60%;margin-top:-450px;">
                                ...
                                <script>
                                        ...
                                        addData.onsubmit = async (e) => {
                                                ...
                                                let r = await fetch('api/medium',{                //send data into server 
                                                        method :'POST',
                                                        body : formData,  //for send data
                                                        headers : {
                                                        'Authorization' :`Bearer ${token}`, 
                                                        }
                                                }).then(response => response.json()).then(data => {window.location.href="/medium";});
                                        }   
                                        ...
                                        updateform.onsubmit = async (e) => {
                                                ...
                                                let a = await fetch(`/api/medium/${id}`,{                //send data into server 
                                                        method :'POST',
                                                        body : formData,  //for send data
                                                        headers : {
                                                        'Authorization' :`Bearer ${token}`,
                                        ...
                                        async function deletePost(postId)
                                        {
                                                ...
                                                let a = await fetch(`/api/medium/${postId}`,{                //send data into server 
                                                        method :'DELETE',
                                                        headers : {
                                                        'Authorization' :`Bearer ${token}`,  
